defmodule Jalka2022Web.UserAuthTest do
  use Jalka2022Web.ConnCase, async: true

  alias Jalka2022.Accounts
  alias Jalka2022Web.UserAuth
  import Jalka2022.AccountsFixtures

  @remember_me_cookie "_jalka2022_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, Jalka2022Web.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      Jalka2022Web.Endpoint.subscribe(live_socket_id)
