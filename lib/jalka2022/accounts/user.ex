defmodule Jalka2022.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_name(changeset) do
    ...
    |> unsafe_validate_unique(:name, Jalka2022.Repo)
    |> unique_constraint(:name)
    |> check_whitelist
  end
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Jalka2022.Repo)
  ...
  """
  def valid_password?(%Jalka2022.Accounts.User{hashed_password: hashed_password}, password)
