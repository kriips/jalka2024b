defmodule Jalka2024Web.Router do
  use Jalka2024Web, :router

  import Jalka2024Web.UserAuth

  pipeline :browser do
    plug(:accepts, ["html"])
    plug(:fetch_session)
    plug(:fetch_live_flash)
    plug(:put_root_layout, {Jalka2024Web.LayoutView, :root})
  ...
  if Application.compile_env!(:jalka2024, :env) in [:dev, :test] do
    import Phoenix.LiveDashboard.Router

    scope "/" do
      pipe_through(:browser)
      live_dashboard("/dashboard", metrics: Jalka2024Web.Telemetry)
    end
  end
