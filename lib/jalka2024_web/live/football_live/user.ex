defmodule Jalka2024Web.FootballLive.User do
  use Phoenix.LiveView

  alias Jalka2024Web.Resolvers.{FootballResolver, AccountsResolver}
  ...
  @impl true
  def render(assigns),
    do: Phoenix.View.render(Jalka2024Web.UserView, "user.html", assigns)
end
