defmodule Jalka2024Web.UserPredictionLive.Groups do
  use Phoenix.LiveView

  alias Jalka2024Web.Resolvers.FootballResolver
  alias Jalka2024Web.LiveHelpers
  alias Jalka2024.Football.{Match}
  ...
  @impl true
  def render(assigns),
    do: Phoenix.View.render(Jalka2024Web.PredictionView, "groups.html", assigns)
